...
import proImg from './images/step4.png';
...
export default function MeasureStep4({data, setData}) {
        ...
        <ScrollView>
            ...
            {rowData.map((row, index) => (
              <View style={styles.row} key={index}>
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_A.A${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_A: {...data.stp4_A, [`A${index + 1}`]: text},
                      });
                    }}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_B.B${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_B: {...data.stp4_B, [`B${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_C.C${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_C: {...data.stp4_C, [`C${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_D.D${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_D: {...data.stp4_D, [`D${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_E.E${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_E: {...data.stp4_E, [`E${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp4_F.F${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp4_F: {...data.stp4_F, [`F${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
          ...
          <View style={{marginBottom: 100}}>
            ...
            <TextInput
              ...
              value={data.stp4_notes}
              onChangeText={(text)=>{setData({...data , stp4_notes : text})}}
            />
          </View>
        </ScrollView>
      </View>
