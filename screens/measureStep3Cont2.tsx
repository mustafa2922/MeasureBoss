...
import proImg from './images/step3cont2.png';
...
export default function MeasureStep3Cont2({data, setData}) {
        ...
        <ScrollView>
          <View style={styles.container}>
            <View style={styles.row}>
              ...
              <View style={styles.column}>
                <Text style={styles.cellText}>F</Text>
              </View>
              <View style={styles.column}>
            ...
            {rowData.map((row, index) => (
              <View style={styles.row} key={index}>
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_A.A${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_A: {...data.stp3C2_A, [`A${index + 1}`]: text},
                      });
                    }}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_B.B${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_B: {...data.stp3C2_B, [`B${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_C.C${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_C: {...data.stp3C2_C, [`C${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_D.D${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_D: {...data.stp3C2_D, [`D${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_E.E${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_E: {...data.stp3C2_E, [`E${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_F.F${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_F: {...data.stp3C2_F, [`F${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3C2_G.G${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3C2_G: {...data.stp3C2_G, [`G${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
          ...
          <View style={{marginBottom: 100}}>
            ...
            <TextInput
              ...
              value={data.stp3C2_notes}
              onChangeText={(text)=>{setData({...data , stp3C2_notes: text})}}
            />
          </View>
        </ScrollView>
      </View>
