...
export default function MeasureStep3({data, setData}) {
        ...
        <ScrollView>
            ...
            {rowData.map((row, index) => (
              <View style={styles.row} key={index}>
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3_A.A${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3_A: {...data.stp3_A, [`A${index + 1}`]: text},
                      });
                    }}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3_B.B${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3_B: {...data.stp3_B, [`B${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3_C.C${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3_C: {...data.stp3_C, [`C${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
                ...
                <View style={styles.column}>
                  <TextInput
                    style={styles.input}
                    value={data[`stp3_D.D${index + 1}`]}
                    onChangeText={text => {
                      setData({
                        ...data,
                        stp3_D: {...data.stp3_D, [`D${index + 1}`]: text},
                      });
                    }}
                    keyboardType="number-pad"
                    maxLength={3}
          ...
          <View style={{marginBottom: 100}}>
            ...
            <TextInput
              ...
              value={data.stp3_notes}
              onChangeText={(text)=>{setData({...data,stp3_notes:text})}}
            />
          </View>
        </ScrollView>
      </View>
